...
You can access the Web UI via this URL: [Phomemo D30 Printer Web UI](https://printer.spicylimes.com/)
...
## History
This Repo is a fork of [Benni306's](https://github.com/Benni306/phomemo-d30-web-bluetooth) and [narrowstacks'](https://github.com/narrowstacks/phomemo-d30-web-bluetooth) Extended Web UI for printing Labels via a Browser on the Phomemo D30 Label Printer. Their Repos were forked from the original creator of this Web UI which can be found [here](https://github.com/odensc/phomemo-d30-web-bluetooth).
